            ...
            <div className='card-body'>
              ...
              <form onSubmit={handleSubmit}>
                <div className='form-control mb-4'>
                  ...
                  <input text ="text" placeholder='Book Title' className='input input-borded' value={title} onChange={(e) => 
                ...
                <div className='form-control mb-4'>
                    ...
                    <input text='number' placeholder='e.g. 2025' className='input input-borded' value={publishYear} onChange={(e) => setPublishYear(e.target.value)} required />                    
                </div>
